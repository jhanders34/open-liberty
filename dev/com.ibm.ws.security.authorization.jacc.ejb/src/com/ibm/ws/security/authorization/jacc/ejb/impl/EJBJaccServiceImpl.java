...
public class EJBJaccServiceImpl implements EJBJaccService {
    ...
    private static final String[] jaccHandlerKeyArray;
    ...
    static {
        ...
        if (principalMapperSupported) {
            ...
            jaccHandlerKeyArray = new String[] { "javax.security.auth.Subject.container", "jakarta.ejb.EnterpriseBean", "jakarta.ejb.arguments",
                                                 "jakarta.xml.soap.SOAPMessage", "jakarta.security.jacc.PrincipalMapper" };
        } else {
            // javax.ejb and javax.xml.soap prefixed strings will be jakarta-ized during transformation
            jaccHandlerKeyArray = new String[] { "javax.security.auth.Subject.container", "javax.ejb.EnterpriseBean", "javax.ejb.arguments",
    ...
    private boolean checkResourceConstraints(String contextId, List<Object> methodParameters, EnterpriseBean bean, Permission ejbPerm, Subject subject, PolicyProxy policyProxy) {
        ...
        try {
            result = checkMethodConstraints(contextId, ma, bean, ejbPerm, subject, ho, policyProxy);
